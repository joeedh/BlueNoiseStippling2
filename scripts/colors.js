...
define([
  ...
  let rgb_to_xyz_rets = new util.cachering(function() {
    return [0, 0, 0];
  }, 512);
  let xyz_to_rgb_rets = new util.cachering(function() {
    return [0, 0, 0];
  }, 512);
  let xyz_to_lab_rets = new util.cachering(function() {
    return [0, 0, 0];
  }, 512);
  let lab_to_xyz_rets = new util.cachering(function() {
    return [0, 0, 0];
  }, 512);
  let lab_to_labch_rets = new util.cachering(function() {
    return [0, 0, 0];
  }, 512);
  let labch_to_lab_rets = new util.cachering(function() {
    return [0, 0, 0];
  }, 512);
  let rgb_to_lab_rets = new util.cachering(function() {
    return [0, 0, 0];
  }, 512);
  let lab_to_rgb_rets = new util.cachering(function() {
    return [0, 0, 0];
  }, 512);
  let rgb_to_cmyk_rets = new util.cachering(function() {
    return [0, 0, 0, 0];
  }, 512);
  
  let rgb_to_xyz = exports.rgb_to_xyz = function rgb_to_xyz(r, g, b) {
    let var_R = r; //( R / 255 )        //R from 0 to 255
    let var_G = g; //( G / 255 )        //G from 0 to 255
    let var_B = b; //( B / 255 )        //B from 0 to 255
  ...
  let xyz_to_rgb = exports.xyz_to_rgb = function xyz_to_rgb(X, Y, Z) {
    let var_X = X / 100        //X from 0 to  95.047      (Observer = 2°, Illuminant = D65)
    let var_Y = Y / 100        //Y from 0 to 100.000
    let var_Z = Z / 100        //Z from 0 to 108.883
  ...
  let lab_to_xyz = exports.lab_to_xyz = function lab_to_xyz(L, a, b) {
    let var_Y = ( L + 16 ) / 116;
  ...
  let xyz_to_lab = exports.xyz_to_lab = function xyz_to_lab(X, Y, Z) {
  ...
  function lab_to_labch(L, a, b) {
    ...
    return ret;
    //let L = L
    //let C = sqrt( CIEa ** 2 + CIEb ** 2 )
    //let H = var_H
  }
  
  let labch_to_lab = exports.labch_to_lab = function labch_to_lab(L, c, h) {
  ...
  let rgb_to_lab = exports.rgb_to_lab = function rgb_to_lab(r, g, b) {
  ...
  let lab_to_rgb = exports.lab_to_rgb = function lab_to_rgb(l, a, b) {
  ...
  let rgb_to_labch = exports.rgb_to_labch = function rgb_to_labch(r, g, b) {
  ...
  let rgb_to_cmyk = exports.rgb_to_cmyk = function rgb_to_cmyk(r, g, b) {
  ...
  let labch_to_rgb = exports.labch_to_rgb = function labch_to_rgb(l, c, h) {
  ...
  exports.closest_color_fast = function closest_color_fast(clr, nextout, fr=0, fg=0, fb=0) {
    ...
    let size = exports.closest_size;
    let map = exports.closest_map;
  ...
  let colors_used = exports.colors_used = new Array();
  let lab_colors = exports.lab_colors = [];
  ...
  exports.image_palette = function image_palette(maxcolor) {
    ...
    let hist = new Int32Array(exports.colors.length);
    ...
    for (let ix=0; ix<cw; ix += dx) {
      ...
      for (let iy=0; iy<ch; iy += dy) {
        ...
        let ci = exports.closest_color(clr);
        hist[ci]++;
      }
    }
    ...
    for (let i=0; i<arr.length; i++) {
      ...
      let clr = exports.colors[arr[i][0]];
  ...
  let lab_colordis = exports.lab_colordis = function lab_colordis(c1, c2) {
  ...
  let colordis_not_diffusing = exports.colordis_not_diffusing = function colordis_not_diffusing(c1, c2) {
  ...
  let colordis_simple = exports.colordis_simple = function colordis_simple(c1, c2) {
  ...
  let colordis = exports.colordis = function colordis(c1, c2) {
  ...
  exports.closest_color2 = function closest_color2(f, c1, nextout, ditherfac) {
    ...
    for (let i=0; i<colors.length; i++) {
      ...
      for (let j=0; j<colors.length; j++) {
        ...
        let dis = colordis(c1, c4, ditherfac);
  ...
  */
  ...
  let barycentric = exports.barycentric = function barycentric(c, c1, c2, c3) {
  ...
  let colorweight = exports.colorweight = function colorweight(r, g, b) {
    let wr=0, wg=0, wb=0;
    let c = _cwc2, tot=0;
